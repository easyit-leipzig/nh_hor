...
<header class="site-header">
  <div class="header-top">
    <a class="brand" href="/nh_hor/index.php" aria-label="easyIT Nachhilfe Leipzig – Startseite">
      <img src="/nh_hor/assets/img/logo.svg" alt="easyIT Nachhilfe Leipzig" width="250" height="88">
    ...
    <div class="header-actions" aria-label="Schnellzugriff">
      <a class="header-action" href="/nh_hor/kontakt.php"><img src="/nh_hor/assets/icons/contact.svg" alt="" width="30" height="30"><span>Kontakt</span></a>
      <a class="header-action" href="/nh_hor/admin/login.php"><img src="/nh_hor/assets/icons/login.svg" alt="" width="30" height="30"><span>Anmelden</span></a>
