...
<section class="section contact-layout" id="kontaktformular">
  <div>
    ...
    <form class="contact-form" action="<?= e(app_path('/kontakt-senden.php')) ?>" method="post" novalidate>
      ...
      <label class="checkbox-label">
        ...
        <span>Ich habe die <a href="<?= e(app_path('/datenschutz.php')) ?>">Datenschutzhinweise</a> gelesen und stimme der Verarbeitung meiner Angaben zur Bearbeitung der Anfrage zu. *</span>
      </label>
