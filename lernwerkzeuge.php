...
$pageCanonical = $site['base_url'] . '/nh_hor/lernwerkzeuge.php';
$pageSchemas = [[
...
<?php foreach($tools as $tool): ?><a class="tool-card" href="/nh_hor/<?= e($tool['file']) ?>"><span class="tool-card__icon" aria-hidden="true"><?= e($tool['icon']) ?></span><strong><?= e($tool['name']) ?></strong><span><?= e($tool['summary']) ?></span></a><?php endforeach; ?>
</div></section>
